...
class Stream(object):
    ...
    def userstream(self,
        ...
        self._start(async_it)

    def firehose(self, count=None, async_it=False):
        self.session.params = {'delimited': 'length'}
        if self.running:
            raise TweepError('Stream object already connected!')
    ...
    def retweet(self, async_it=False):
        self.session.params = {'delimited': 'length'}
        if self.running:
            raise TweepError('Stream object already connected!')
    ...
    def sample(self, async_it=False, languages=None):
        self.session.params = {'delimited': 'length'}
        if self.running:
            raise TweepError('Stream object already connected!')
    ...
    def filter(self, follow=None, track=None, async_it=False, locations=None,
    ...
    def sitestream(self, follow, stall_warnings=False,
                   with_='user', replies=False, async_it=False):
        self.body = {}
        if self.running:
            raise TweepError('Stream object already connected!')
